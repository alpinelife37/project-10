          ...
          <div class="card  border-dark text-white shadow-lg" style="max-width: 18rem;">
            ...
            <div class="card-body bg-light">
              <ul class="list-group list-group-flush text-dark shadow-sm">
                <li class="list-group-item list-group-item-warning">ID: ${managerArray[0].id}</li>
                <li class="list-group-item list-group-item-warning">Email: <a href="mailto: ${managerArray[0].email}"
                    target="_blank">${managerArray[0].email}</a></li>
                <li class="list-group-item list-group-item-warning">Office Number: ${managerArray[0].officeNumber}</li>
              </ul>
