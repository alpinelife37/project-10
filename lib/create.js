...
const create = (managerArray, internArray, engineerArray) => {
    ...
    return `<div class="card border-dark text-white shadow-lg" style="max-width: 18rem;">
      ...
      <div class="card-body bg-light">
        <ul class="list-group list-group-flush text-dark shadow-sm">
          ...
          <li class="list-group-item list-group-item-warning">GitHub: <a href="https://github.com/${
            employee.github
    ...
    return `<div class="card border-dark text-white shadow-lg" style="max-width: 18rem;">
      ...
      <div class="card-body bg-light">
        <ul class="list-group list-group-flush text-dark shadow-sm">
          ...
          <li class="list-group-item list-group-item-warning">School: ${
            employee.school
          }</li>
        </ul>
  ...
  fs.writeFile("./output/rockstarTeam.html", html, function(err) {
    if (err) {
